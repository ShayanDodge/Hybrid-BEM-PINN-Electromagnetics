function integrale = intnormalsquare_post(sideLabels, sourcePoint, fieldIdx, boundaryNodes, ~, lengthX, lengthY, ~)
% Computes the integral of the normal derivative of the fundamental solution
% over one boundary element for post-processing in a rectangular domain.
%
% Inputs:
